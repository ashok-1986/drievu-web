...
| Teal-Blue Start | `#05a1c9` | `--color-teal-blue-start` | Solid start color for the teal-blue gradient |
| Gradient Teal-Blue | `linear-gradient(90deg, rgb(5, 161, 201) 0%, rgb(61, 80, 252) 100%)` | `--gradient-teal-blue` | Hero gradient banner, brand transition washes — teal flowing into cobalt creates a continuous energy signal |
...
:root {
  ...
  --color-teal-blue-start: #05a1c9;
  --gradient-teal-blue: linear-gradient(90deg, rgb(5, 161, 201) 0%, rgb(61, 80, 252) 100%);
