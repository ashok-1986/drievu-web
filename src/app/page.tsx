...
export default function HomePage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // 1. Trionn Word-Stagger Hero Reveal (60ms stagger, out-expo curve)
      ...
      // 2. SVG Process Line Draw (Animates left-to-right on scroll into view)
      if (processLineRef.current) {
        ...
        gsap.to(processLineRef.current, {
          ...
          scrollTrigger: {
            ...
            start: "top 75%",
            once: true, // Triggers once and never replays
          },
        });
      }

      // 3. Stat Counter Animation (Counts up smoothly over 1.2s on first view)
  ...
  /* 
   * 12TH-GRADE PLAIN ENGLISH SYSTEMS DICTIONARY
   * All technical jargon (IP67, IK10, H.265+, PoE, NVR) is strictly isolated to /systems/[category].
   * Maximum structural font weight applied: font-medium (500).
   */
  const systemsGrid = [
    {
  ...
  /* 
   * 12TH-GRADE PROCESS WORKFLOW
   * Friendly, humanized action words replacing dry corporate terminology.
   */
  const workProcess = [
  ...
  return (
    <div ref={heroRef} className="flex flex-col w-full overflow-hidden">
      {/* 
        * SECTION 1: Trionn Mega-Scale Editorial Hero
        * Strictly capped at weight 500 (font-medium). Uses clamp() and negative tracking [-0.04em].
        * Zero premature CTAs cluttering the top of the viewport.
        */}
      <section className="relative min-h-[85vh] flex flex-col justify-between px-6 py-12 max-w-[1200px] mx-auto w-full">
        <div className="pt-6 md:pt-12">
          ...
          <p className="font-body font-normal text-brand-slate/85 text-lg md:text-xl max-w-2xl leading-relaxed mb-12">
            Most properties buy good hardware but end up with poor results—late installations, messy wiring, and systems nobody maintains. We design, install, and look after your security and building controls from start to finish so they work every single day.
          </p>

          <div className="flex flex-wrap items-center gap-4">
            {/* Emil Kowalski Tactile Button Physics: active:scale-[0.97] */}
            <Link
              href="/consultation"
            ...
            >
              Try Interactive System Estimate
            </Link>
          </div>
        </div>

        {/* Plain-English Trust Strip (Verifiable claims only) */}
      ...
      {/* 
        * SECTION 2: DB Longbow Systems Grid
        * 100vh Curtain Reveals [data-reveal="curtain"] + Embedded Antigravity AI Image Prompts.
        * All CTAs drive to Consultation OR Technical Depth pages.
        */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {systemsGrid.map((sys) => {
              ...
              return (
                ...
                >
                  <div>
                    {/* DB Longbow Curtain Reveal Container with AI Prompt Reference */}
                  ...
                  {/* Dual-Action Footer: Drive to Specifiers Tech Hub OR Scoping Quote */}
      ...
      {/* 
        * SECTION 3: Track Record Teaser & Stat Counters
        * Zero Canary Wharf / Manchester fakes. References genuine Wankhede / BARC track record.
        */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="font-body font-normal text-brand-slate/85 text-base leading-relaxed">
              Drievu was founded in London in 2024 by a leadership team with more than two decades of experience delivering security and building systems across some of the most demanding sites in Asia and Africa.
            </p>
            
            {/* MANDATORY LEGAL & PROCUREMENT DISCLAIMER */}
            <div className="bg-brand-mist p-5 rounded-xl border-l-4 border-brand-teal font-body text-xs text-brand-grey leading-relaxed font-mono">
              <strong>DUE DILIGENCE NOTE:</strong> National-infrastructure projects listed were delivered by members of Drievu’s leadership team over the past two decades in prior executive roles. Drievu Limited was incorporated in the UK in 2024 (Company No. 15479482).
            </div>
      ...
      {/* 
        * SECTION 4: Process Rail with SVG Line Draw
        * 12th-Grade friendly action words: Listen -> Support. Max Weight 500.
        */}
      <section id="process-section" className="bg-brand-slate text-brand-paper py-24 px-6 relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <div className="relative">
            {/* Horizontal Connecting Line (SVG stroke-dashoffset animates on scroll) */}
      ...
      {/* 
        * SECTION 5: Primary Conversion Banner
        * Funnels all engaged traffic directly into the Requirement Form (/consultation).
        */}
