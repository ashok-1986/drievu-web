      ...
      <section className="py-16 px-6 max-w-[1000px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 space-y-10 font-body font-normal text-sm md:text-base text-brand-slate/85 leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="font-display font-medium text-xl md:text-2xl text-brand-slate tracking-tight border-b border-brand-grey/20 pb-3">
                2. Interactive System Builder & Indicative Estimates
              </h2>
              <p>
                Our front-of-house Interactive System Builder provides deterministic, rule-based engineering calculations regarding video storage capacities (in Terabytes), hardware channel counts, and network switch sizing based on our deployed product range.
              </p>
              <ul className="list-disc pl-6 space-y-2 text-brand-slate/80">
                <li>
                  <strong className="font-medium text-brand-slate">Indicative Nature:</strong> All outputs generated by the System Builder are strictly indicative engineering estimates intended to assist specifiers and property managers during initial project discovery. They do not constitute a binding financial quote, contract of sale, or formal design proposal.
                </li>
                <li>
                  <strong className="font-medium text-brand-slate">No Automated AI Scoring:</strong> Drievu evaluates system integrity through verifiable electrical and mechanical engineering mathematics (such as H.265+ bitrate formulas and HDD bay mapping) rather than arbitrary AI scoring algorithms.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="font-display font-medium text-xl md:text-2xl text-brand-slate tracking-tight border-b border-brand-grey/20 pb-3">
                3. Scoping Reviews & Response Commitments
              </h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="font-display font-medium text-xl md:text-2xl text-brand-slate tracking-tight border-b border-brand-grey/20 pb-3">
                4. System Design, Supply & Installation Standards
              </h2>
              <p>
            ...
            <div className="bg-brand-mist p-6 rounded-2xl border border-brand-grey/20 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-display font-medium text-lg text-brand-slate tracking-tight">
                  5. Documented Handover Guarantee
                </h3>
              </div>
            ...
            <div className="space-y-4 pt-4 border-t border-brand-grey/20">
              <h2 className="font-display font-medium text-xl md:text-2xl text-brand-slate tracking-tight">
                9. Contacting Our Legal & Engineering Team
              </h2>
              <p className="text-sm">
