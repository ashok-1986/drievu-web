...
export default function SectorsPage() {
  ...
  /* 
   * SCROLL SPY FOR STICKY NAVIGATION [source: 2]
   * Highlights the active sector pill as the buyer scrolls down the page [source: 2].
   */
  useEffect(() => {
    const handleScroll = () => {
  ...
  /* 
   * 12TH-GRADE PLAIN ENGLISH SECTOR DICTIONARY [source: 2]
   * Strict structure: Buyer's Problem -> Drievu Solution -> Verifiable Proof Point [source: 2].
  ...
  const sectorsData = [
    {
      ...
      icon: Building2,
      problem: "You design beautiful, clean spaces, but traditional security installers often ruin the aesthetic with bulky boxes, ugly surface-mounted cables, and hardware that clashes with your finishes [source: 3].",
      solution: "We work with you during the early planning stage [source: 1, 3]. We map out hidden wiring routes, specify flush-mounted cameras and glass intercom panels, and ensure every piece of technology blends invisibly into your design without sacrificing safety [source: 3, 4].",
      proofTitle: "Verified Leadership Track Record [source: 2, 3]",
      proofDesc: "Our executive team engineered seamless, high-end building systems across luxury residential towers like Altair and landmark commercial developments like GIFT City [source: 3].",
    ...
    },
    {
      ...
      tagline: "On-time installations that never delay your building handover [source: 3].",
      icon: Shield,
      problem: "Subcontractors routinely over-specify expensive gear to inflate their invoices, show up late, and leave you with incomplete paperwork that delays your ability to sell, let, or hand over the property [source: 3].",
      solution: "We price transparently and install strictly to your construction schedule [source: 3]. You receive reliable, right-sized equipment without fluff, finished with a complete, structured handover document pack so you can close your project immediately [source: 3].",
      proofTitle: "Live UK Delivery Discipline [source: 2]",
      proofDesc: "At our Staines Road commercial estate installation in London, we delivered a 31-camera network and video storage system on schedule with zero tenant disruption and full insurance documentation [source: 2, 4].",
    ...
    },
    {
      ...
      tagline: "Reliable systems that work every day, backed by fast support [source: 3].",
      icon: Wrench,
      problem: "You inherit systems with messy wiring, zero documentation, and constant false alarms [source: 3]. When something breaks, the original installer is nowhere to be found, leaving your building exposed [source: 3].",
      solution: "We bring order to operational chaos [source: 3]. We provide SLA-backed annual maintenance contracts with a guaranteed response within one working day [source: 2, 3]. We tidy up your existing setups and give you a single, simple app to manage cameras and doors easily [source: 3, 4].",
      proofTitle: "Infrastructure-Grade Reliability [source: 3]",
      proofDesc: "Our leadership team spent over two decades managing mission-critical security and communication systems for major airports, metros, and stadiums where failure is not an option [source: 3].",
    ...
    },
    {
      ...
      tagline: "British safety standards with strict tenant privacy protection [source: 2, 3].",
      icon: FileText,
      problem: "You need to protect residents and communal properties while staying strictly within public budgets and complying with complex UK data privacy and building safety laws [source: 1, 3].",
      solution: "We specify durable, energy-efficient hardware engineered to British safety guidelines [source: 2, 3]. Every system builds in automatic privacy protection for residents, zero recurring cloud storage fees, and full audit documentation for your compliance records [source: 3, 4].",
      proofTitle: "Public Due-Diligence Ready [source: 1, 2]",
      proofDesc: "Drievu Limited is a UK-registered company (Reg No. 15479482) operating with self-hosted digital systems and transparent, documented processes designed to pass rigorous procurement audits [source: 1, 3].",
  ...
  return (
    <div className="w-full pb-24 bg-brand-paper min-h-screen">
      ...
      <section className="bg-brand-slate text-brand-paper py-16 md:py-24 px-6 border-b border-brand-grey/20">
        <div className="max-w-[1200px] mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-teal/20 text-brand-teal text-xs font-display font-medium uppercase tracking-widest mb-6 select-none">
            ...
            Tailored Engineering Engagement [source: 2]
          </div>
          ...
          <p className="font-body font-normal text-brand-grey text-lg md:text-xl max-w-3xl leading-relaxed mb-8">
            We do not force a single boxed product onto every building [source: 3]. Whether you specify new developments, manage day-to-day facilities, or oversee public housing, here is how our consulting-to-maintenance discipline solves your exact problems in plain English [source: 2, 3].
          </p>

          {/* Mandatory Legal & Due Diligence Banner [source: 2, 3] */}
          <div className="bg-brand-mist/10 border-l-4 border-brand-teal p-5 rounded-r-xl max-w-4xl font-body text-xs text-brand-grey leading-relaxed font-mono">
            <strong>PROCUREMENT DUE DILIGENCE [source: 2]:</strong> National-infrastructure track records referenced below were delivered by members of Drievu’s leadership team over the past two decades in prior executive roles [source: 2, 3]. Drievu Limited was incorporated in the UK in 2024 (Company No. 15479482) [source: 3].
          </div>
        </div>
      </section>

      {/* 
        * STICKY SECTOR JUMP NAVIGATION (SC-4) [source: 2]
        * Allows decision-makers to bypass scrolling and jump straight to their section [source: 2].
        */}
      ...
      {/* 
        * 4 ANCHORED SECTOR SECTIONS (SC-1, SC-2, SC-3) [source: 2]
        * Strict Rule: Every section terminates at the exact same scoping CTA [source: 2].
        */}
            ...
            >
              <div className={`grid grid-cols-1 lg:grid-cols-12 gap-12 items-center ${isEven ? "lg:grid-flow-dense" : ""}`}>
                ...
                <div className={`lg:col-span-7 space-y-8 ${isEven ? "lg:col-start-6" : ""}`}>
                  ...
                  {/* Problem vs Solution Comparison Box [source: 2] */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-brand-teal/40 shadow-soft space-y-2">
                      <span className="font-display font-medium text-xs text-brand-teal uppercase tracking-wider block flex items-center gap-1.5">
                        <CheckCircle2 className="w-3.5 h-3.5" /> How Drievu Solves It [source: 2]
                      </span>
                  ...
                  {/* Verifiable Proof Point [source: 2] */}
                  <div className="border-l-2 border-brand-slate pl-5 py-1 space-y-1">
                    <span className="font-display font-medium text-xs text-brand-slate uppercase tracking-wider block">
                      Proof Point: {sec.proofTitle} [source: 2]
                    </span>
                  ...
                  {/* UNIFIED CONVERSION GOAL (SC-3): Routes strictly to Scoping Wizard [source: 2] */}
                  <div className="pt-2">
                    <Link
                      href="/consultation"
                    ...
                    >
                      <span>Book a Scoping Review for This Sector [source: 2]</span>
                      <ArrowRight className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
                    </Link>
                  </div>
                </div>

                {/* DB Longbow Image Curtain Reveal (5 Columns) [source: 3, 5] */}
                <div className={`lg:col-span-5 ${isEven ? "lg:col-start-1" : ""}`}>
                  <div className="w-full h-[380px] md:h-[440px] bg-brand-slate/10 rounded-2xl relative overflow-hidden border border-brand-grey/20 shadow-soft flex items-center justify-center" data-reveal="curtain">
                    ...
                    {/* Embedded Antigravity AI Image Prompt Reference [source: 5] */}
      ...
      {/* 
        * FINAL UNIVERSAL CONVERSION BANNER [source: 2]
        * Catches buyers who scrolled through all four sectors without clicking [source: 2].
        */}
      <section className="mt-12 bg-brand-teal text-white py-20 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-body font-normal text-brand-paper/90 text-base md:text-lg mb-8 leading-relaxed">
            Submit your site details or unit counts today [source: 2]. An engineering principal will review your requirements and respond within one working day to arrange your structured scoping review [source: 2, 3].
          </p>
          <Link
            href="/consultation"
          ...
          >
            Start Your Requirement Form [source: 1, 2]
          </Link>
        </div>
      </section>
    </div>
